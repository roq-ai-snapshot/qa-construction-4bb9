...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'outlet.create': { roles: ['owner'], key: 'outlet-added', tenantPath: ['company', 'outlet'], userPath: [] },
  'outlet.delete': { roles: ['owner'], key: 'outlet-removed', tenantPath: ['company', 'outlet'], userPath: [] },
  'rental.create': {
    roles: ['owner', 'admin'],
    key: 'tool-rented',
